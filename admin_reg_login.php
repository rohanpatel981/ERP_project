<?php
	...
	if (isset($_POST[''])) // front-end... 
	{
		...
		$user_check_query = "SELECT * FROM admin_users WHERE username=".$username." ";
	...
	if (isset($_POST[''])) {  // frontend....
  		...
  		if (count($errors)==0) {
  			...
  			$results=mysqli_query($db,"select * from admin_users where username=".$username." and password=".$password." ");
